# Pattern-Aware PACE Engine

<details>
  <summary><strong>Table of Contents</strong></summary>

- [Purpose](#purpose)
- [Current Engine (Already Implemented)](#current-engine-already-implemented)
- [Important Gaps in Current Behavior](#important-gaps-in-current-behavior)
- [Recommended PACE Architecture](#recommended-pace-architecture)
  - [Layer 1: Deterministic Rules (High Trust)](#layer-1-deterministic-rules-high-trust)
  - [Layer 2: Heuristic Scoring (Medium Trust)](#layer-2-heuristic-scoring-medium-trust)
  - [Layer 3: Human Confirmation (Low Trust)](#layer-3-human-confirmation-low-trust)
- [Confidence Thresholds](#confidence-thresholds)
- [Ambiguous Case Handling](#ambiguous-case-handling)
- [Data Quality Rules](#data-quality-rules)
- [Testing Assets Included](#testing-assets-included)
- [Practical Test Procedure](#practical-test-procedure)
- [Success Criteria](#success-criteria)

</details>

## Purpose
PACE is Argent's transaction categorization strategy. The rules here target ambiguous payments — MB WAY transfers, offshore descriptors, and small local purchases — where simple keyword matching breaks down.

The strategy aligns with the current implementation in [lib/PACE.ts](../lib/PACE.ts) and extends toward confidence-based matching.

## Current Engine (Already Implemented)
The current PACE engine:
...
Use these files:
- [docs/fake-PACE-rules.json](./fake-PACE-rules.json)
- [docs/fake-PACE-transactions-test.json](./fake-PACE-transactions-test.json)
...
1. Load rules from `docs/fake-PACE-rules.json`.
2. For each fake transaction, run current `runPACE(description, rules)`.
