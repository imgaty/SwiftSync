...
//  Description: Handles the /api/auth/2fa/setup API endpoint for Argent, keeping request parsing,
...
export async function POST() {
  try {
    ...
    return NextResponse.json({ error: e instanceof Error ? e.message : "Failed to set up 2FA" }, { status: 500 })
  }
}
